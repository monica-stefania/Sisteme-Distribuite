        ...
        val receiveInQueueSubscription = receiveInQueueObservable
            ...
            .subscribeBy(
                ...
                onComplete = {
                    ...
                    val statsMsg1 = Message.create("MessageProcessor", "count")
                    numberOfMessagesSocket.getOutputStream().write(statsMsg1.serialize())
                    auctioneerConnection.close()
        ...
        try {
            ...
            Observable.fromIterable(messageQueue).subscribeBy(
                onNext = {
                    ...
                    val statsMsg2 = Message.create("MessageProcessor", "count")
                    numberOfMessagesSocket.getOutputStream().write(statsMsg2.serialize())
                },
                onComplete = {
                    ...
                    val statsMsgFinal = Message.create("MessageProcessor", "final")
                    numberOfMessagesSocket.getOutputStream().write(statsMsgFinal.serialize())
