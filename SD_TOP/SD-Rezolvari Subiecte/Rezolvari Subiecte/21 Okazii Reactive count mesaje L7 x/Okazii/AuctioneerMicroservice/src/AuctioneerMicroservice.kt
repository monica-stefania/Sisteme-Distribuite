        ...
        try {
            ...
            subscriptions.add(Observable.fromIterable(bidQueue).subscribeBy(
                onNext = {
                    ...
                    val m1 = Message.create("Auctioneer", "count")
                    numberOfMessagesSocket.getOutputStream().write(m1.serialize())
                ...
                onComplete = {
                    ...
                    val m2 = Message.create("Auctioneer", "count")
                    numberOfMessagesSocket.getOutputStream().write(m2.serialize())
