...
def resolve_question(question_text):
    ...
    # incercare de conectare catre microserviciul STUDENT
    try:
        ...
        # primire raspuns -> microserviciul STUDENT foloseste coregrafia de microservicii pentru a trimite raspunsul inapoi
